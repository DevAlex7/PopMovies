...
class myPDF extends PDF {
    ...
    function header(){
        ...
        $this->Cell(276, 5, 'Informe de compras a proveedores',0,0,'C');
        $this->Ln();
    ...
    function headerTable(){
        ...
        $this->Cell(50,10,'Sucursal',1,0,'C');
        $this->Cell(50,10,'Proveedor',1,0,'C');
    ...
    function viewTable(){
        ...
        $this->SetFont('Times','',12);
        $result = $this->LeerComprasaProveedor();
        foreach($result as $row){
            $this->Cell(50, 10, $row['enterprise'], 1 ,'L',false);
            $this->Cell(50, 10, $row['name'], 1 ,'L',false);
            $this->MultiCell(95, 10, $row['Moviename'], 1 ,'L',false);
            $this->Ln();
        }
    }
}

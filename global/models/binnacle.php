...
class Binnacle extends Validator{
    ...
    public function actionsInAdmins(){
        $sql='SELECT binnacle.date, admins.id, admins.username AS adminUser, binnacle.actionperformed, binnacle.site FROM admins, binnacle WHERE admins.id=binnacle.admin_id ORDER BY binnacle.id DESC';
        $params=array(null);
